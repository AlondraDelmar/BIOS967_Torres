---
title: "Individual Project R"
author: "Alondra Torres"
date: "2023-12-08"
output: html_document
---

#Starting Individual Project \# Load Required Packages
...
![](Screenshot (389).png){width="477"}

![](Screenshot (390).png){width="477"}
```